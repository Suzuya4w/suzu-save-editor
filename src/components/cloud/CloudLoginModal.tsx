...
interface CloudLoginModalProps {
  isOpen: boolean;
  onClose: () => void;
  handleLogin: (provider: 'discord' | 'github' | 'google') => void;
}

export function CloudLoginModal(props: CloudLoginModalProps) {
  return (
    <Modal
     isOpen={props.isOpen}
    ...
    >
     <div class="flex flex-col items-center">
        ...
        <div class="w-full flex flex-col gap-4 font-black uppercase tracking-widest">
         <button onClick={() => props.handleLogin('discord')} class="w-full py-4 border-2 border-[#5865F2] text-[#5865F2] hover:bg-[#5865F2] hover:text-white transition-colors cursor-pointer flex items-center justify-center gap-3 text-sm shadow-[4px_4px_0px_rgba(88,101,242,0.3)] hover:shadow-[4px_4px_0px_rgba(88,101,242,1)]">
         ...
         <button onClick={() => props.handleLogin('github')} class="w-full py-4 border-2 border-zinc-500 text-zinc-300 hover:bg-zinc-300 hover:text-black transition-colors cursor-pointer flex items-center justify-center gap-3 text-sm shadow-[4px_4px_0px_rgba(113,113,122,0.3)] hover:shadow-[4px_4px_0px_rgba(113,113,122,1)]">
         ...
         <button onClick={() => props.handleLogin('google')} class="w-full py-4 border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white transition-colors cursor-pointer flex items-center justify-center gap-3 text-sm shadow-[4px_4px_0px_rgba(239,68,68,0.3)] hover:shadow-[4px_4px_0px_rgba(239,68,68,1)]">
