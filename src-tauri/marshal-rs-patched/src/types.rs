...
pub struct Object(pub IndexMap<String, Value, RandomState>);
...
impl Deref for Object {
    type Target = IndexMap<String, Value, RandomState>;
...
#[derive(Debug, Default, Clone, PartialEq, Eq)]
pub struct HashMap(pub IndexMap<Value, Value, RandomState>);
...
impl Deref for HashMap {
    type Target = IndexMap<Value, Value, RandomState>;
